...
<body>
    <div class="container">
        <form class="well form-horizontal" action="signIN" method="POST" id="contact_form" modelAttribute="softtesting">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 inputGroupContainer">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                            <input name="cpwd" placeholder="Confirm Password" class="form-control" type="password">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 inputGroupContainer">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                            <input name="photo" class="form-control" type="file" accept="image/gif, image/jpeg, image/png">
                        </div>
                    </div>
                </div>
